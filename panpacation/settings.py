"""
Django settings for panpacation project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-_l_vc61=j@35iws4%5_ho+^j2n9yel$3xzroq(n^utp3ky#_d8')
...
WSGI_APPLICATION = 'panpacation.wsgi.application'
